...
VALUES (1000, 'André', 'de Groot', 'Male', '28-07-2000', 'Image url'),
       ...
       (1003, 'Bruce', 'de Groot', 'Male', '16-01-2014', 'Image url'),
       (1004, 'Priscilla', 'de Groot', 'Female', '07-01-1984', 'Image url'),
       (1005, 'Caroline', 'de Groot', 'Female', '21-01-1999', 'Image url'),
       (1006, 'Sandy', 'de Groot', 'Female', '22-01-2011', 'Image url'),
       (1007, 'Peter', 'de Groot', 'Male', '31-01-2002', 'Image url'),
       (1008, 'Pieter', 'de Groot', 'Male', '14-01-1987', 'Image url'),
       (1009, 'Ellen', 'de Groot', 'Female', '01-01-1983', 'Image url'),
       (1010, 'Mike', 'de Groot', 'Male', '01-01-1983', 'Image url'),
       (1011, 'Michael', 'de Groot', 'Male', '01-01-1983', 'Image url'),
       (1012, 'Kim', 'de Groot', 'Female', '01-01-1983', 'Image url'),
       (1013, 'Kees', 'de Groot', 'Male', '01-01-1983', 'Image url');

INSERT INTO movies (movie_id, movie_title, movie_summary, movie_year_of_release, movie_image_url)
VALUES (1001, 'The Incredible Hulk', 'Bruce Banner, a scientist on the run from the U.S. Government, must find a cure for the monster he turns into whenever he loses his temper.', '2008', 'image-url-hulk'),
       (1002, 'The Avengers', 'Earths mightiest heroes must come together and learn to fight as a team if they are going to stop the mischievous Loki and his alien army from enslaving humanity.', '2012', 'image-url-the-avengers'),
       (1003, 'Avengers: Age of Ultron', 'When Tony Stark and Bruce Banner try to jump-start a dormant peacekeeping program called Ultron, things go horribly wrong and it''s up to Earths mightiest heroes to stop the villainous Ultron from enacting his terrible plan.', '2015', 'image-url-age-of-ultron'),
       (1004, 'Thor: Ragnarok', 'Imprisoned on the planet Sakaar, Thor must race against time to return to Asgard and stop Ragnarök, the destruction of his world, at the hands of the powerful and ruthless villain Hela.', '2017', 'image-url-thor-ragnarok'),
       (1005, 'Avengers: Infinity War', 'The Avengers and their allies must be willing to sacrifice all in an attempt to defeat the powerful Thanos before his blitz of devastation and ruin puts an end to the universe.', '2018', 'image-url-avengers-infinity-war'),
       (1006, 'Avengers: Endgame', 'After the devastating events of Avengers: Infinity War the universe is in ruins. With the help of remaining allies, the Avengers assemble once more in order to reverse Thanos his actions and restore balance to the universe.', '2019', 'image-url-avengers-endgame'),
       (1007, 'Thor', 'The powerful but arrogant god Thor is cast out of Asgard to live amongst humans in Midgard (Earth), where he soon becomes one of their finest defenders.', '2011', 'image-url-thor'),
       (1008, 'Thor: The Dark World', 'When the Dark Elves attempt to plunge the universe into darkness, Thor must embark on a perilous and personal journey that will reunite him with doctor Jane Foster.', '2013', 'image-url-thor-dark-world'),
       (1009, 'Thor: Love and Thunder', 'Thor enlists the help of Valkyrie, Korg and ex-girlfriend Jane Foster to fight Gorr the God Butcher, who intends to make the gods extinct.', '2022', 'image-url-thor-love-thunder'),
       (1010, 'Iron Man', 'After being held captive in an Afghan cave, billionaire engineer Tony Stark creates a unique weaponized suit of armor to fight evil.', '2008', 'image-url-iron-man'),
       (1011, 'Iron Man 2', 'With the world now aware of his identity as Iron Man, Tony Stark must contend with both his declining health and a vengeful mad man with ties to his father''s legacy.', '2010', 'image-url-iron-man-2'),
       (1012, 'Iron Man 3', 'When Tony Stark''s world is torn apart by a formidable terrorist called the Mandarin, he starts an odyssey of rebuilding and retribution.', '2013', 'image-url-iron-man-3'),
       (1013, 'Captain America: Civil War', 'Political involvement in the Avengers'' affairs causes a rift between Captain America and Iron Man.', '2016', 'image-url-captain-america-civil-war'),
       (1014, 'Spider-Man: Homecoming', 'Peter Parker balances his life as an ordinary high school student in Queens with his superhero alter-ego Spider-Man, and finds himself on the trail of a new menace prowling the skies of New York City.', '2017', 'image-url-spider-man-homecoming'),
       (1015, 'Spider-Man: Far From Home', 'Following the events of Avengers: Endgame, Spider-Man must step up to take on new threats in a world that has changed forever.', '2019', 'image-url-spider-man-far-from-home'),
       (1016, 'Spider-Man: No Way Home', 'With Spider-Mans identity now revealed, Peter asks Doctor Strange for help. When a spell goes wrong, dangerous foes from other worlds start to appear, forcing Peter to discover what it truly means to be Spider-Man.', '2021', 'image-url-spider-man-no-way-home'),
       (1017, 'Spider-Man 4', 'Unknown', '0000', 'image-url-spider-man-4'),
       (1018, 'Captain America: The first avenger', 'Steve Rogers, a rejected military soldier, transforms into Captain America after taking a dose of a "Super-Soldier serum". But being Captain America comes at a price as he attempts to take down a warmonger and a terrorist organization.', '2011', 'image-url-captain-america-the-first-avenger'),
       (1019, 'Captain America: The Winter Soldier', 'As Steve Rogers struggles to embrace his role in the modern world, he teams up with a fellow Avenger and S.H.I.E.L.D agent, Black Widow, to battle a new threat from history: an assassin known as the Winter Soldier.', '2014', 'image-url-captain-america-the-winter-soldier'),
       (1020, 'Ant-Man', 'Armed with a super-suit with the astonishing ability to shrink in scale but increase in strength, cat burglar Scott Lang must embrace his inner hero and help his mentor, Dr. Hank Pym, pull off a plan that will save the world.', '2015', 'image-url-ant-man'),
       (1021, 'Captain America: Brave New World', 'Plot kept under wraps. Fourth movie in the Captain America franchise.', '2025', 'image-url-captain-america-brave-new-world'),
       (1022, 'Doctor Strange in the Multiverse of Madness', 'Doctor Strange teams up with a mysterious girl from his dreams who can travel across multiverses, to battle multiple threats which threaten to wipe out millions across the multiverse. They seek help from Wanda the Scarlet Witch, Wong and others.', '2022', 'image-url-doctor-strange-multiverse-of-madness'),
       (1023, 'Black Panther', 'TChalla, heir to the hidden but advanced kingdom of Wakanda, must step forward to lead his people into a new future and must confront a challenger from his country''s past.', '2018', 'image-url-black-panther'),
       (1024, 'Black Panther: Wakanda Forever', 'The people of Wakanda fight to protect their home from intervening world powers as they mourn the death of King TChalla.', '2022', 'image-url-black-panther-wakanda-forever'),
       (1025, 'Black Widow', 'Natasha Romanoff confronts the darker parts of her ledger when a dangerous conspiracy with ties to her past arises.', '2021', 'image-url-black-widow'),
       (1026, 'Ant-Man and the Wasp', 'As Scott Lang balances being both a superhero and a father, Hope van Dyne and Dr. Hank Pym present an urgent new mission that finds the Ant-Man fighting alongside The Wasp to uncover secrets from their past.', '2018', 'image-url-ant-man-and-the-wasp'),
       ...
       (1028, 'Thunderbolts', 'A group of supervillains are recruited to go on missions for the government.', '2025', 'image-url-thunderbolts'),
       (1029, 'Doctor Strange', 'While on a journey of physical and spiritual healing, a brilliant neurosurgeon is drawn into the world of the mystic arts.', '2016', 'image-url-doctor-strange'),
       (1030, 'Captain Marvel', 'Carol Danvers becomes one of the universe''s most powerful heroes when Earth is caught in the middle of a galactic war between two alien races.', '2019', 'image-url-captain-marvel'),
       (1031, 'The Marvels', 'Carol Danvers gets her powers entangled with those of Kamala Khan and Monica Rambeau, forcing them to work together to save the universe.', '2023', 'image-url-the-marvels');
