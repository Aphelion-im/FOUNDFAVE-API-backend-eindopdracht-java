...
VALUES (1000, 'The Incredible Hulk',
       ...
       (1015, 'Spider-Man: No Way Home',
        ...
        '2021', 'image-url-spider-man-no-way-home'),
       ...
       (1018, 'Captain America: The Winter Soldier',
        ...
        '2014', 'image-url-captain-america-the-winter-soldier'),
       (1019, 'Ant-Man',
       ...
       (1021, 'Doctor Strange in the Multiverse of Madness',
        ...
        '2022', 'image-url-doctor-strange-multiverse-of-madness'),
       (1022, 'Black Panther',
       ...
       (1023, 'Black Panther: Wakanda Forever',
        ...
        '2022', 'image-url-black-panther-wakanda-forever'),
       (1024, 'Black Widow',
        'Natasha Romanoff confronts the darker parts of her ledger when a dangerous conspiracy with ties to her past arises.',
        '2021', 'image-url-black-widow'),
       (1025, 'Ant-Man and the Wasp',
        'As Scott Lang balances being both a superhero and a father, Hope van Dyne and Dr. Hank Pym present an urgent new mission that finds the Ant-Man fighting alongside The Wasp to uncover secrets from their past.',
        '2018', 'image-url-ant-man-and-the-wasp'),
       (1026, 'Ant-Man and the Wasp: Quantumania',
        ...
        '2023', 'image-url-ant-man-and-the-wasp-quantumania'),
       (1027, 'Thunderbolts', 'A group of supervillains are recruited to go on missions for the government.', '2025',
        'image-url-thunderbolts'),
       (1028, 'Doctor Strange',
        'While on a journey of physical and spiritual healing, a brilliant neurosurgeon is drawn into the world of the mystic arts.',
        '2016', 'image-url-doctor-strange'),
       (1029, 'Captain Marvel',
        'Carol Danvers becomes one of the universe''s most powerful heroes when Earth is caught in the middle of a galactic war between two alien races.',
        '2019', 'image-url-captain-marvel'),
       (1030, 'The Marvels',
        'Carol Danvers gets her powers entangled with those of Kamala Khan and Monica Rambeau, forcing them to work together to save the universe.',
        '2023', 'image-url-the-marvels');
